...
PKG_SECTION="service"
PKG_SHORTDESC="Net-SNMP adds Simple Network Management Protocol (SNMP)."
PKG_LONGDESC="Net-SNMP (${PKG_VERSION}) adds support for Simple Network Management Protocol (SNMP) health and welfare monitoring."
